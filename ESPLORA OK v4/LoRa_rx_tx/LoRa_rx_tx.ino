...
void loop() {
 ...
 float h = dht.readHumidity();
    ...
    int sensorValue1 = 1;//analogRead(A0); // Leer valor del primer sensor
    int sensorValue2 = analogRead(5); // Leer valor del segundo sensor
    int sensorValue3 = 3;//analogRead(A2); // Leer valor del tercer sensor
    
    String sensorData = String(t) + "," + String(sensorValue2) + "," + String(sensorValue3);
